...
#load data
recfin = read_csv("C:/Users/NHack/Downloads/CTE001-California-2015-2017.csv")
```
...
norcal = dplyr::filter(recfin, RECFIN_SUBREGION_NAME == 'Northern California') %>% 
  ...
  dplyr::summarise('count' = sum(SUM_RETAINED_NUM), 'mass' = sum(SUM_RETAINED_MT))%>%
...
knitr::kable(recshort, caption = "Species groups")
```
